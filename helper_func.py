...
def preproc_gen_toks_legacy_print(gen_toks, input_len, tokenizer):
    """Process generated tokens from model keeping only up to \n\n
...
def verify_pred_from_output_legacy_print(self, output, sample_a, print_output=False):
...
def verify_pred_from_output(
    output, sample_a, preprocess_func, fun_def_mod=False, print_output=False
):
    """Verify the the output generates the solution
